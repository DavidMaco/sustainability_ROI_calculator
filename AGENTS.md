...
pytest tests -q
python -m pyright config.py domain/models.py domain/scenarios.py domain/optimization.py domain/monte_carlo.py ingestion/factory.py ingestion/external_api_adapter.py ingestion/sqlite_adapter.py security.py secrets_adapter.py scripts/healthcheck.py scripts/load_test.py scripts/perf_report.py scripts/metrics_server.py
```
